...
namespace CPHAllocationDay2
{
    public partial class CodedWorkflow : CodedWorkflowBase
    {
        private Lazy<global::CPHAllocationDay2.WorkflowRunnerService> _workflowRunnerServiceLazy;
        private Lazy<ConnectionsManager> _connectionsManagerLazy;
        public CodedWorkflow()
        {
            _ = new System.Type[]{typeof(UiPath.Excel.Activities.API.IExcelService), typeof(UiPath.Mail.Activities.Api.IMailService), typeof(UiPath.Core.Activities.API.ISystemService), typeof(UiPath.Testing.API.ITestingService), typeof(UiPath.UIAutomationNext.API.Contracts.IUiAutomationAppService), typeof(UiPath.Word.Activities.API.IWordService)};
            _workflowRunnerServiceLazy = new Lazy<global::CPHAllocationDay2.WorkflowRunnerService>(() => new global::CPHAllocationDay2.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::CPHAllocationDay2.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
